...
rob = User.find_or_create_by(name: "Rob", username: "robocop", email: "rob@gmail.com", password_digest: "#{User.digest("1234")}", avatar: "http://placeimg.com/300/301/animals")
...
black_shirt = Clothing.find_or_create_by(name: "Black Crew T-Shirt", brand: "VC", description: "For the rugged, wild, and free. Or been smoking 8 years but can still hold his breath for 2 minutes type of guy", image_url: "https://images.pexels.com/photos/1703083/pexels-photo-1703083.jpeg?auto=compress&cs=tinysrgb&dpr=3&h=750&w=1260", user: jc)

charcoal_wool_pants = Clothing.find_or_create_by(name: "Charcoal Gray Plaid Wool Pants", brand: "Banana Republic", description: "Richly textured wool defines handsome dress pants crafted in a clean flat-front cut.", image_url: "https://images.pexels.com/photos/2897521/pexels-photo-2897521.jpeg?auto=compress&cs=tinysrgb&dpr=3&h=750&w=1260", user: cal)
