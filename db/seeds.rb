...
#user_clothings
denim_measurement1 = UserClothing.find_or_create_by(user: rob, clothing: denim_jacket, measurements: "14x15x16", size: small_for_denim)
denim_measurement2 = UserClothing.find_or_create_by(user: rob, clothing: denim_jacket, measurements: "15x16x17", size: med_for_denim)
denim_measurement3 = UserClothing.find_or_create_by(user: rob, clothing: denim_jacket, measurements: "16x17x18", size: large_for_denim)
denim_measurement4 = UserClothing.find_or_create_by(user: rob, clothing: denim_jacket, measurements: "17x18x19", size: xlarge_for_denim)
wool_measurement1 = UserClothing.find_or_create_by(user: rob, clothing: charcoal_wool_pants, measurements: "30x36", size: wool_pants30)
wool_measurement2 = UserClothing.find_or_create_by(user: cal, clothing: charcoal_wool_pants, measurements: "32x37", size: wool_pants32)
wool_measurement3 = UserClothing.find_or_create_by(user: rob, clothing: charcoal_wool_pants, measurements: "34x37", size: wool_pants34)
wool_measurement4 = UserClothing.find_or_create_by(user: cal, clothing: charcoal_wool_pants, measurements: "36x37", size: wool_pants36)
slim_dress_meas1 = UserClothing.find_or_create_by(user: sang, clothing: slim_dress_pants, measurements: "28x34", size: slim_dresspants30)
slim_dress_meas2 = UserClothing.find_or_create_by(user: sang, clothing: slim_dress_pants, measurements: "34x34", size: slim_dresspants36)
slim_dress_meas3 = UserClothing.find_or_create_by(user: jc, clothing: slim_dress_pants, measurements: "33x34", size: slim_dresspants34)
