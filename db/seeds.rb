...
wool_measurement1 = UserClothing.find_or_create_by(user: rob, clothing: charcoal_wool_pants, size: wool_pants30, bottomWaist: 30, bottomLength: 30, bottomHip: 30, bottomThigh: 30, bottomBottomHem: 30)
wool_measurement2 = UserClothing.find_or_create_by(user: cal, clothing: charcoal_wool_pants, size: wool_pants32, bottomWaist: 32, bottomLength: 32, bottomHip: 32, bottomThigh: 32, bottomBottomHem: 32)
